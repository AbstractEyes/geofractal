...
class ValidationTests:
    ...
    def test_basic_functionality(self):
        ...
        def test():
            config = CantorAttentionPlusConfig(
                dim=512,
                num_heads=8,
                local_window=64,
                dropout=0.0,
            ...
            attn = CantorAttentionPlus(config).to(self.device)
    ...
    def test_causal_masking(self):
        ...
        def test():
            attn = create_cantor_attention_plus(
                dim=512,
                num_heads=8,
                local_window=64,
                dropout=0.0,
    ...
    def test_gradient_flow(self):
        ...
        def test():
            config = CantorAttentionPlusConfig(dim=512, num_heads=8, dropout=0.0)
            attn = CantorAttentionPlus(config).to(self.device)
    ...
    def test_causal_vs_noncausal(self):
        ...
        def test():
            config_causal = CantorAttentionPlusConfig(dim=256, num_heads=4, dropout=0.0, causal=True)
            config_noncausal = CantorAttentionPlusConfig(dim=256, num_heads=4, dropout=0.0, causal=False)

            attn_causal = CantorAttentionPlus(config_causal).to(self.device)
            attn_noncausal = CantorAttentionPlus(config_noncausal).to(self.device)
    ...
    def test_autoregressive(self):
        ...
        def test():
            config = CantorAttentionPlusConfig(dim=128, num_heads=4, dropout=0.0, causal=True)
            attn = CantorAttentionPlus(config).to(self.device)
            attn.eval()
    ...
    def test_adaptive_vs_fixed(self):
        ...
        def test():
            config_fixed = CantorAttentionPlusConfig(
                dim=256,
                num_heads=4,
                local_window=32,
                adaptive_window=False,
            ...
            config_adaptive = CantorAttentionPlusConfig(
                dim=256,
                num_heads=4,
                adaptive_window=True,
                min_window=16,
            ...
            attn_fixed = CantorAttentionPlus(config_fixed).to(self.device)
            attn_adaptive = CantorAttentionPlus(config_adaptive).to(self.device)
...
class BenchmarkRunner:
    ...
    def run_benchmark(self):
        ...
        for seq_len, batch_size in test_configs:
            ...
            try:
                cantor_model = CantorAttentionPlus(config).to(self.device)
